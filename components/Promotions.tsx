...
const stockListIcon = () => (
  <>
    ...
    >
      <path
        d="M2.8125 4.6875H4.6875V6.5625H2.8125V4.6875ZM0.9375 2.8125V4.6875V6.5625V8.4375H2.8125H4.6875H6.5625V6.5625V4.6875V2.8125H4.6875H2.8125H0.9375ZM10.3125 4.6875H9.375V6.5625H10.3125H29.0625H30V4.6875H29.0625H10.3125ZM10.3125 14.0625H9.375V15.9375H10.3125H29.0625H30V14.0625H29.0625H10.3125ZM10.3125 23.4375H9.375V25.3125H10.3125H29.0625H30V23.4375H29.0625H10.3125ZM4.6875 14.0625V15.9375H2.8125V14.0625H4.6875ZM2.8125 12.1875H0.9375V14.0625V15.9375V17.8125H2.8125H4.6875H6.5625V15.9375V14.0625V12.1875H4.6875H2.8125ZM2.8125 23.4375H4.6875V25.3125H2.8125V23.4375ZM0.9375 21.5625V23.4375V25.3125V27.1875H2.8125H4.6875H6.5625V25.3125V23.4375V21.5625H4.6875H2.8125H0.9375Z"
        fill="#FFB300"
      />
    </svg>
  </>
...
const stats = [
  { title: "Active Promotions", value: "10", icon: stockListIcon },
  { title: "Leads Generated", value: "250", icon: InventoryIcon },
  { title: "Expired Promotions", value: "6", icon: CarsAddedIcon },
  { title: "Promotion Views", value: "2.5k", icon: CarsSoldIcon },
];

const promotions = [
  {
    id: 1,
    promotionName: "Summer Flash Sale",
    type: "Flash Sale",
    period: "Apr 25 - May 1 2024",
    appliedCars: 8,
    performance: "1.8k Views, 127 Leads",
    status: "Active",
  },
  {
    id: 2,
    promotionName: "Featured SUVs Week",
    type: "Discounted",
    period: "Apr 25 - May 1 2024",
    appliedCars: 4,
    performance: "1.8k Views, 127 Leads",
  ...
  {
    id: 3,
    promotionName: "Spring Specials Week",
      ...
      <div className="">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {promotions.map((item) => (
                  <tr
                    key={item.id}
                    className="border-b last:border-0 text-left text-[#555555] md:text-base text-sm"
                  >
                    <td className="p-3 px-6 border-r">{item.promotionName}</td>
                    <td className="p-3 px-6 border-r">{item.type}</td>
                    <td className="p-3 px-6 border-r">{item.period}</td>
                    <td className="p-3 px-6 border-r">{item.appliedCars}</td>
                    <td className="p-3 px-6 border-r">{item.performance}</td>
        ...
        <div className="flex items-center justify-between w-full border-t pt-4">
          ...
          <div className="flex items-center gap-2 text-sm text-black">
            <span>Page</span>
            <Select defaultValue={currentPage.toString()}>
            ...
            <div className="w-fit whitespace-nowrap">of {totalPages}</div>
          </div>
          ...
          <div className="w-fit">
            <Pagination>
              <PaginationContent className="gap-1">
                <PaginationItem>
                  <PaginationPrevious className="h-8 w-8 bg-white text-black hover:bg-amber-400 border" />
                </PaginationItem>

                <PaginationItem>
                  <PaginationLink
                    isActive
                    className="h-8 w-8 bg-amber-400 text-black hover:bg-amber-400 border-none"
                  >
                    1
                  </PaginationLink>
                </PaginationItem>
                ...
                <PaginationItem>
                  <PaginationLink className="h-8 w-8 bg-white text-black hover:bg-amber-400 border">
                    2
                  </PaginationLink>
                </PaginationItem>
                ...
                <PaginationItem>
                  <PaginationNext className="h-8 w-8 bg-white text-black hover:bg-amber-400 border" />
                </PaginationItem>
              </PaginationContent>
            </Pagination>
          </div>
