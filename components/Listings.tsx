...
export default function ListingPage() {
  return (
    <div className=" space-y-6">
      <h1 className="text-2xl font-semibold">Car Listing</h1>
          ...
          <CardContent className="overflow-x-auto px-0">
            <table className="w-full text-sm">
              <thead className="bg-[#F6F9FF]">
                <tr>
                  <th colSpan={2} className="text-lg font-normal text-black p-3 px-6 border-r">Make</th>
                  <th className="text-lg font-normal text-black p-3 px-6 border-r">Model</th>
                  <th className="text-lg font-normal text-black p-3 px-6 border-r">Year</th>
                  <th className="text-lg font-normal text-black p-3 px-6 border-r">Mileage</th>
                  <th className="text-lg font-normal text-black p-3 px-6 border-r">Actions</th>
                  <th className="text-lg font-normal text-black p-3 px-6">Status</th>
                ...
                {inventory.map((item) => (
                  <tr key={item.id} className="border-b last:border-0 text-center text-[#555555] md:text-base text-sm">
                    <td className="text-right w-12">
                        <Checkbox className=" h-4 w-4 rounded border border-gray-300 bg-white data-[state=checked]:bg-yellow-400 data-[state=checked]:text-black data-[state=checked]:border-yellow-400">
                    ...
                    <td className="p-3 pr-6 border-r">
                      <div className="flex items-center sm:flex-row flex-col justify-center lg:gap-4 gap-3">
                        ...
                        <span className=" whitespace-nowrap">{item.make}</span>
                      </div>
                    </td>
                    <td className="p-3 px-6 border-r">{item.model}</td>
                    <td className="p-3 px-6 border-r">{item.year}</td>
                    <td className="p-3 px-6 border-r">{item.mileage}</td>
